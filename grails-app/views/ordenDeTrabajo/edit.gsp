...
<html>
    ...
    <body>
        ...
        <div id="edit-ordenDeTrabajo" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.ordenDeTrabajo}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.ordenDeTrabajo}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.ordenDeTrabajo}" method="PUT">
                <g:hiddenField name="version" value="${this.ordenDeTrabajo?.version}" />
                <fieldset class="form">
                    <f:all bean="ordenDeTrabajo"/>
                </fieldset>
